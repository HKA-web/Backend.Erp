...
ELSE
        ...
        VALUES (v_rec.city_id, v_rec.province_id, v_rec.city_name, 'POSTED', v_rec.is_removed, NOW(), NOW())
...
END IF;
    ...
    IF v_rec.temporary_option <> 'D' THEN
SELECT to_jsonb(t) INTO v_new_data FROM core.city t WHERE t.city_id = v_rec.city_id;
END IF;
